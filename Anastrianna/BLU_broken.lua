...
function maps()		
        ...
        BlueMagic_Buff = S{
                                                ...
                                                'Orcish Counterstance','Plasma Charge','Pyric Bulwark','Reactor Cool','Erratic Flutter'}
...
function get_sets()
	...
	-- DT Sets
        sets.PDT = {ammo="Honed tathlum",
                    ...
                    ear1="Ethereal Earring",ear2="Suppanomimi",
                    body="Iuitl Vest +1",
       ...
       sets.TP.Normal = {}  
        ...
        sets.TP['LowAcc'] = {ammo="Honed tathlum",
                             head="Taeon Chapeau",
                             neck="Asperity Necklace",
                             ear1="Brutal Earring", ear2="Suppanomimi",
                             body="Taeon Tabard",
        ...
        -- High Haste Sets
        -- ~40%+ Haste
        sets.TP.HighHaste = {ammo="Jukukik Feather",
                             head="Taeon Chapeau",
                             neck="Asperity Necklace",
                             ear1="Brutal Earring", ear2="Suppanomimi",
                             body="Taeon Tabard",
        ...
        sets.SavageBlade.Attack ={ammo="Honed Tathlum",
                                  head="Luh. Keffiyeh +1",
                                  neck="Fotia Gorget",
                                  ear1="Flame Pearl",ear2="Flame Pearl",
                                  body="Luhlaza Jubbah +1",
	...
	--Blue Magic Sets--
        ...
        sets.BlueMagic.Cures = {ammo="Hydrocera",
                                head="Telchine Cap",
                                neck="Twilight Torque",
                                ear1="Enchntr. Earring +1",ear2="Moonshade Earring",
                                body="Telchine Chas.",
	...
	--Precast Sets--
        ...
        sets.precast.FC.Standard = {ammo="Mavi Tathlum",
                                    head="Helios Band",
                                    neck="Mavi Scarf",
...
ACCMODE = "A"
       ...
       -- LETS OVERRIDE THE SETS WE EQUIP IF PDT OR MDT ARE SET - THESE ARE KING AS THEY HAPPEN LAST
        if PDTmode == 'on' then
                equip(sets.PDT)
                                if Fujidebug == 'on' then add_to_chat(200, 'FujiDebug: ~~~ PDT     ~~') end
