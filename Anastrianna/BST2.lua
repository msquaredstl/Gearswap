...
function user_setup()
    state.OffenseMode:options('None','Normal', 'HighAcc')
...
function init_gear_sets()
    -- AUGMENTED GEAR
    Pet_PDT_AxeMain = { "Kumbhakarna", augments={'Pet: Accuracy +15 Pet: Rng. Acc.+15','Pet: TP Bonus +80','Pet: Phys. dmg. taken -4%',}}
    ...
    Ready_Atk_body = Pet_PDT_body
    Ready_Atk_hands = "Nukumi Manoplas"
    ...
    Ready_MAB_head = { name="Acro Helm", augments={'Pet: Mag. Acc.+12',}}
    Ready_MAB_body = Pet_PDT_body
    Ready_MAB_hands = { name="Acro Gauntlets", augments={'Pet: "Mag.Atk.Bns."+17',}}
    Ready_MAB_legs = { name="Acro Breeches", augments={'Pet: Mag. Acc.+11',}}
    Ready_MAB_feet = { name="Acro Leggings", augments={'Pet: Mag. Acc.+14',}}
    ...
    Ready_Atk_Axe1 = { "Kumbhakarna", augments={'Pet: Accuracy +15 Pet: Rng. Acc.+15','Pet: TP Bonus +80','Pet: Phys. dmg. taken -4%',}}
    Ready_Acc_Axe1 = Ready_Atk_Axe1
	Ready_Atk_Axe2 = { "Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+15','Pet: TP Bonus +200',}}
    Ready_Acc_Axe2 = Ready_Atk_Axe2
    Ready_MAB_Axe1 = { "Kumbhakarna", augments={'Pet: TP Bonus +160','Pet: "Mag.Atk.Bns."+11',}}
    Ready_MAcc_Axe1 = Ready_MAB_Axe1
	Ready_MAB_Axe2 = { "Kumbhakarna", augments={'Pet: "Mag.Atk.Bns."+15','Pet: TP Bonus +200',}}
    Ready_MAcc_Axe2 = Ready_MAB_Axe2
	
    Pet_Melee_head = "Anwig Salade"
    Pet_Melee_body = Ready_Atk_body
    Pet_Melee_hands = Ready_Atk_hands
    Pet_Melee_legs = Ready_Atk_legs
    Pet_Melee_feet = Ready_Atk_feet

    Hybrid_head = "Taeon Chapeau"
    Hybrid_body = "Taeon Tabard"
    Hybrid_hands = "Taeon Gloves"
    Hybrid_legs = "Taeon Tights"
    ...
    sets.midcast.FastRecast = {
                head="Skormoth Mask",neck="Twilight Torque",ear1="Loquacious Earring",ear2="Enchanter Earring +1",
                body="Taeon Tabard",hands="Buremte Gloves",ring1="Lebeche Ring",ring2="Defending Ring",
                back="Shadow Mantle",waist="Nierenschutz",legs="Nukumi Quijotes +1",feet="Taeon Boots"}
    ...
    sets.precast.WS = {
		ammo="Flame Sachet",head="Skormoth Mask",neck="Snow Gorget",ear1="Heartseeker Earring",
		ear2="Brutal Earring",body="Nukumi Gausape +1",hands="Nukumi Manoplas +1",ring1="Ifrit Ring",
		ring2="Ifrit Ring",back="Annealed Mantle",waist="Metalslinger Belt",legs="Nukumi Quijotes +1",
		feet="Nukumi Ocrea"}

    sets.precast.WS.WSMedAcc = {
		ammo="Hasty Pinion +1",head="Skormoth Mask",neck="Snow Gorget",ear1="Heartseeker Earring",
		ear2="Brutal Earring",body="Nukumi Gausape +1",hands="Nukumi Manoplas +1",ring1="Ifrit Ring",
		ring2="Ifrit Ring",back="Annealed Mantle",waist="Metalslinger Belt",legs="Nukumi Quijotes +1",
		feet="Nukumi Ocrea"}
    ...
    sets.precast.WS.WSHighAcc = {
		ammo="Hasty Pinion +1",head="Skormoth Mask",neck="Snow Gorget",ear1="Heartseeker Earring",
		ear2="Brutal Earring",body="Nukumi Gausape +1",hands="Nukumi Manoplas +1",ring1="Mars's Ring",
		ring2="Enlivened Ring",back="Pastoralist's Mantle",waist="Anguinus Belt",legs="Nukumi Quijotes +1",
		feet="Nukumi Ocrea"}
    ...
    sets.midcast.Pet.WS = {ammo="Demonry Core",
        neck="Ferine Necklace",ear2="Hija Earring",ear1="Sabong Earring",
		head=Ready_Atk_head,
        body=Ready_Atk_body,
    ...
    sets.idle.Regen ={ammo="Demonry Core",head="Oce. Headpiece +1",neck="Bathy Choker +1",
		...
		ring1="Sheltered Ring",ring2="Paguroidea Ring",waist="Muscle Belt +1",legs="Nukumi Quijotes +1",feet="Acro Leggings"}
    ...
    sets.idle.Pet = {ammo="Sihirik",head="Oce. Headpiece +1",neck="Bathy Choker +1",ear1="Dawn Earring",
		ear2="Infused Earring",body="Kumarbi's Akar",hands="Umuthi Gloves",back="Pastoralist's Mantle",
    ...
    sets.idle.Pet.Engaged = {
		...
		sets.idle.Pet.Engaged.HighAcc = {main ="Izizoeksi",sub={ name="Kumbhakarna", augments={'Pet: Accuracy+17 Pet: Rng. Acc.+17','Pet: Damage taken -4%','Pet: TP Bonus+200',}},
		ammo="Demonry Core",head="Anwig Salade",neck="Ferine Necklace",ear1="Rimeice Earring",
		ear2="Handler's Earring +1",
		body={ name="Acro Surcoat", augments={'Pet: Accuracy+21 Pet: Rng. Acc.+21','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}},
		hands={ name="Acro Gauntlets", augments={'Pet: Accuracy+24 Pet: Rng. Acc.+24','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}},
		 ring1="Thurandaut Ring",ring2="Paguroidea Ring",
		back="Pastoralist's Mantle",waist="Isa Belt",legs="Nukumi Quijotes +1",
		feet={ name="Acro Leggings", augments={'Pet: Accuracy+22 Pet: Rng. Acc.+22','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}}
