...
function init_gear_sets()
    ...
    sets.precast.JA['Elemental Siphon'] = {main="Soulscourge",
        ...
        body="Caller's Doublet +2",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Globidonta Ring",
        legs="Marduk's Shalwar +1",feet="Caller's Pigaches +2"}

    sets.precast.JA['Mana Cede'] = {hands="Caller's Bracers +2"}

    -- Pact delay reduction gear
    sets.precast.BloodPactWard = {ammo="Seraphicaller",head="Accord Hat +1",body="Glyphic Doublet +1",hands="Convoker's Bracers +1", back="Conveyance Cape", feet="Glyphic Pigaches +1"}
    ...
    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",
        ...
        back="Swith Cape +1",waist="Witful Belt",legs="Hagondes Pants +1",feet="Hagondes Sabots +1"}

	sets.midcast['Enhancing Magic'] = { head="Befouled Crown", neck="Colossus's Torque",feet="Regal Pumps" }
    ...
    sets.midcast.Pet.BloodPactWard = {main="Gridarvor",ammo="Seraphicaller",
        head="Convoker's Horn +1",neck="Caller's Pendant",
        body="Caller's Doublet +2",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Globidonta Ring",
        waist="Jaq'il Sash",legs="Helios Spats"}

    sets.midcast.Pet.DebuffBloodPactWard = {main="Gridarvor",ammo="Seraphicaller",
        head="Convoker's Horn +1",neck="Caller's Pendant",
        body="Caller's Doublet +2",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Globidonta Ring",
        waist="Jaq'il Sash",legs="Helios Spats"}
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main="Keraunos",ammo="Seraphicaller",
        head="Convoker's Horn +1",neck="Caller's Pendant", ear2="Gelos Earring",
        body="Convoker's Doublet +1",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Globidonta Ring",
        waist="Mujin Obi",legs="Enticer's Pants",feet="Convoker's Pigaches +1"}

    sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.PhysicalBloodPactRage

    sets.midcast.Pet.MagicalBloodPactRage = {main="Keraunos",ammo="Seraphicaller",
        head="Glyphic Horn",neck="Caller's Pendant", ear2="Gelos Earring",
        body="Convoker's Doublet +1",hands="Glyphic Bracers +1",ring1="Evoker's Ring",ring2="Globidonta Ring",
        back="Samanisi Cape",waist="Caller's Sash",legs="Enticer's Pants",feet="Hagondes Sabots +1"}

    sets.midcast.Pet.MagicalBloodPactRage.Acc = sets.midcast.Pet.MagicalBloodPactRage
    sets.midcast.Pet.MagicalBloodPactRage['Flaming Crush'] = set_combine(sets.midcast.Pet.MagicalBloodPactRage,{ ring2="Fervor Ring" })
    ...
    sets.resting = {main="Boonwell Staff",ammo="Seraphicaller",
        ...
        back="Pahtli Cape",waist="Austerity Belt",legs="Assiduity Pants +1",feet="Chelona Boots +1"}
    ...
    sets.idle.Avatar = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
        head="Convoker's Horn +1",neck="Caller's Pendant",ear1="Domesticator's Earring",ear2="Moonshade Earring",
        body="Glyphic Doublet +1",hands="Hagondes Cuffs +1",ring1="Evoker's Ring",ring2="Sangoma Ring",
        back="Conveyance Cape",waist="Fucho-no-Obi",legs="Assiduity Pants +1",feet="Convoker's Pigaches +1"}

    sets.idle.PDT.Avatar = {main="Gridarvor",sub="Vox Grip",ammo="Seraphicaller",
        head="Convoker's Horn +1",neck="Caller's Pendant",ear1="Domesticator's Earring",ear2="Moonshade Earring",
        body="Hagondes Coat +1",hands="Regimen Mittens",ring1="Evoker's Ring",ring2="Defending Ring",
        back="Conveyance Cape",waist="Fucho-no-Obi",legs="Hagondes Pants +1",feet="Convoker's Pigaches +1"}
    ...
    sets.perp.Carbuncle = {main="Bolelabunga",sub="Genbu's Shield",
        head="Convoker's Horn +1",body="Hagondes Coat +1",hands="Carbuncle Mitts",legs="Assiduity Pants +1",feet="Convoker's Pigaches +1"}
    -- Jaq'il Sash doesn't gain us anything at this time
    --sets.perp.Diabolos = {waist="Jaq'il Sash"}
    sets.perp.Alexander = sets.midcast.Pet.BloodPactWard

    sets.perp.staff_and_grip = {main=gear.perp_staff,sub="Vox Grip"}
    
    -- Defense sets
    sets.defense.PDT = {main="Ungeri Staff",
        head="Hagondes Hat +1",neck="Wiglen Gorget",ear1="Gifted Earring",ear2="Loquacious Earring",
        body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Defending Ring",
